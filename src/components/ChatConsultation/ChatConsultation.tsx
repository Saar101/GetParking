                            ...
                            return (
                              ...
                              >
                                ...
                                <div className="chat-consultation-panel__item-meta">
                                  ...
                                  <span>מחיר: {lot.hasKnownPricing === false ? "לא ידוע" : `₪${lot.price} ${lot.pricingLabel}`}</span>
                                  <span>הנחה: {lot.hasKnownPricing === false ? "לא ידועה" : lot.salePrice !== null ? `₪${lot.salePrice} ${lot.salePricingLabel ?? ""}`.trim() : "אין"}</span>
